'use client';
import PageTitleBox from "@/components/page-title-box";
import TimeRecordRow from "@/components/time-records/time-record-row";
import timeRecordsProvider, { TimeRecord } from "@/providers/time-records";
...
export default function Page({ params }: any) {
  ...
  return (
    <Box
      ...
      gap={"5em"}
    >
      <PageTitleBox title={`Time Records / ${params.projectUuid}`} />
